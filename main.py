...
CATEGORIES = {
    ...
    "스포츠 선수": [
        "김도영", "양현종", "원태인", "강백호", "배정대", "박병호", "최정", "이정후", "김광현", "강민호",
        "최형우", "구자욱", "이의리", "소형준", "문보경", "김현수", "오승환", "정우영", "김하성", "박세웅",
        "전준우", "나성범", "이대호", "박해민", "강상원"
    ],
    "방송인/배우": [
    ...
    "애니/영화 캐릭터": [
        "아냐 포저", "루피", "엘사", "안나", "피카츄", "도라에몽", "짱구", "카구야", "미사카 미코토",
        "나루토", "사스케", "덴지", "파워", "마리오", "루이지", "올라프", "스파이더맨", "아이언맨",
        "캡틴 아메리카", "토르", "조커", "배트맨", "슈퍼맨", "이누야샤", "신지"
    ]
}
